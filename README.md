...
|------------------------------------------|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [C#](c%23-template-engines.md)           | 8                  | DotLiquid, Fluid, Handlebars.Net, MJML.Net, RazorLight, Scriban, Spark, Stubble                                                                                   |
...
| [Python](python-template-engines.md)     | 10                 | Chameleon, Cheetah3, Chevron, Genshi, Jinja, Jsonnet, Kajiki, Mako, Pystache, Unprompted                                                                          |
